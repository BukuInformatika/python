...
Berikut penggunaan Operator Bitwise
Operator bitwise bekerja pada bit dan melakukan sedikit demi sedikit operasi. Asumsikan jika a = 60; dan b = 13; Sekarang dalam format biner mereka akan sebagai berikut 
a = 0011 1100
b = 0000 1101
a & b = 0000 1100
a | b = 0011 1101
...
x << y
     Mengembalikan x dengan bit bergeser nilai y
x >> y
     Mengembalikan x dengan bit bergeser nilai y. Ini sama dengan // dengan x 2 ** y.
x & y
     Setiap bit dari output adalah 1 jika bit yang sesuai dari x AND dari y adalah 1, jika tidak maka itu adalah 0.
x | y
     Setiap bit dari output adalah 0 jika bit yang sesuai dari x AND dari y adalah 0, jika tidak, itu adalah 1.
~ x
     Mengembalikan nilai x - jumlah yang Anda dapatkan dengan mengganti masing-masing 1 untuk angka 0 dan masing-masing 0 untuk angka 1. Ini sama dengan -x - 1.
x ^ y
    Setiap bit dari output sama dengan bit yang sesuai pada x jika bit di y adalah 0, dan itu adalah pelengkap bit pada x jika bit di y adalah 1.
