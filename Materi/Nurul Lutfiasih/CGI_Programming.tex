...
\begin{document}
\sloppy
\begin{center}{\fontsize{14pt}{14pt}\selectfont \textbf{CGI }\textbf{PROGRAMMING} \\}\end{center} \par
\vspace{14pt}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=4.09in,height=2.25in]{./uploads_new/CGI_Programming.docx_DIR/media/image4.jpg}
\end{center}
\end{figure}
