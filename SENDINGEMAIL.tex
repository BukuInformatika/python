...
\vspace{12pt}
\noindent 
\section {\textbf {Server Pada Mail Server dan Penjelasannya 
...
\end{enumerate} 
\begin{itemize}
\item Email Address : contoh —> 1. anda@domainanda.com 2. Incoming Mail (POP3, IMAP or HTTP) server : mail.doaminanda.com 3. Outgoing (SMTP) server : mail.domainanda.com 4. Account Name : anda@domainanda.com 5. Password : password yang telah anda buat sebelumnya 
