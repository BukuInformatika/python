...
\item	Diteruskan dengan klik environtment variables seperti pada gambar \ref{environment_variables} setelah muncul pop up cari path itu adalah nama dari variable nya. Jika tidak ada cari tempat penyimpanan python pada direktori C seperti pada gambar \ref{directori_python}
\begin{figure}[ht]
...
\end{figure}
\begin{figure}[ht]
	\centerline{\includegraphics[width=0.70\textwidth]{figures/directori_python.PNG}}
	\caption{Lokasi Python}
	\label{directori_python}
\end{figure}
	
\item	Lalu klik path tersebut setelah itu edit seperti pada gambar \ref{edit_ev}
\begin{figure}[ht]
...
\noindent
{\fontsize{14pt}{14pt}\selectfont Sedangkan untuk instalasi virtualenv pada windows kita harus memastikan pip sudah terinstal. Caranya bisa dilihat seperti pada gambar \ref{cek_pip} \\} \par
\noindent
\begin{figure}[ht]
	\centerline{\includegraphics[width=0.70\textwidth]{figures/cek_pip.PNG}}
	\caption{Cek Pip}
	\label{cek_pip}
\end{figure}

{\fontsize{14pt}{14pt}\selectfont Kemudian ketikkan pada cmd \verb|pip help| lalu akan muncul informasi seperti pada gambar \ref{pip_help} \\} \par
\noindent
\begin{figure}[ht]
	\centerline{\includegraphics[width=0.70\textwidth]{figures/pip_help.PNG}}
	\caption{Pip Help}
	\label{pip_help}
\end{figure}

{\fontsize{14pt}{14pt}\selectfont Setelah itu barulah kita instal dengan mengetikkan perintah \verb|pip install virtualenv| seperti pada gambar \ref{install_virtualenv} \\} \par
\noindent
\begin{figure}[ht]
	\centerline{\includegraphics[width=0.70\textwidth]{figures/install_virtualenv.PNG}}
	\caption{Install Virtualenv Pip}
	\label{install_virtualenv}
\end{figure}
