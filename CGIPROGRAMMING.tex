...
\begin{enumerate}
	...
	\item Buka directory Xampp dan masuk ke folder apache  \$  \rightarrow  \$ Conf dan cari file httpd dot conf 
	\item Buka file httpd dot conf menggunakan notepad 
	\item Cari baris dan tambahkan ExecCGI pada list Options FollowSymLinks  
