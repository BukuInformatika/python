...
\begin{enumerate}
\item Stackless Python Terpengaruh oleh : 68, C, C++, Dylan ABC, ALGOL Haskell, Icon, Java, Lisp, Modula-3
\item Perl Mempengaruhi : Boo, Cobra, D, Falcon, Groovy, JavaScript
\item Ruby Sistem operasi : Cross-platform
\item Lisensi : Python Software Foundation License
\item GNU GPL Situs web : python.org
\end{enumerate}
